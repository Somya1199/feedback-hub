...
//                                     Cannot calculate pending users without employee mapping data.
//                                   </div>
//                                 </div>
//                               </div>
//                             </div>
...
//                                 <span className="text-blue-700">{employeeMappings.length}</span>
//                                 <span className="mx-2">-</span>
//                                 <span className="text-green-700">{stats.uniqueSubmitters}</span>
//                                 <span className="mx-2">=</span>
...
//                                 (Total Employees - Unique Submitters)
//                               </div>
//                             </div> */}
...
//                                   style={{
//                                     width: `${employeeMappings.length > 0
//                                       ? Math.min(100, (stats.uniqueSubmitters / employeeMappings.length) * 100)
//                                       : 0}%`
//                                   }}
//                                 ></div>
//                               </div>
...
//                               <summary className="cursor-pointer text-xs font-medium text-gray-700 hover:text-gray-900 flex items-center justify-center">
//                                 <Users className="w-3 h-3 mr-1" />
//                                 View {Math.min(employeeMappings.length, 5)} sample employees
//                               </summary>
//                               <div className="mt-2 space-y-1 max-h-40 overflow-y-auto text-left">
//                                 {employeeMappings.slice(0, 5).map((emp, index) => (
//                                   <div key={index} className="flex justify-between items-center p-2 hover:bg-gray-50 rounded text-xs">
//                                     <div className="truncate">
//                                       <div className="font-medium truncate">{emp.Ldap || 'No name'}</div>
//                                       <div className="text-gray-500 truncate">{emp.Email || 'No email'}</div>
//                                     </div>
//                                     <div className="text-gray-500 text-xs">{emp.Process || 'Unknown'}</div>
//                                   </div>
//                                 ))}
//                                 {employeeMappings.length > 5 && (
//                                   <div className="text-center text-xs text-gray-500 p-1">
//                                     ... and {employeeMappings.length - 5} more employees
//                                   </div>
//                                 )}
//                               </div>
//                             </details> */}
...
//                               <span>✓ Using mapping sheet data</span>
//                             </div>
//                           </div> */}
//                         </>
//                       )}
...
//                               {/* <div className="mb-6">
//         <h5 className="font-medium mb-3 text-blue-700">Feedback Distribution</h5>
//         <div className="space-y-2">
//           {[
//             { key: 'saFeedback', label: 'Strongly Agree', color: 'bg-green-600' },
//             { key: 'aFeedback', label: 'Agree', color: 'bg-green-400' },
//             { key: 'nFeedback', label: 'Neutral', color: 'bg-yellow-400' },
//             { key: 'dFeedback', label: 'Disagree', color: 'bg-orange-400' },
//             { key: 'sdFeedback', label: 'Strongly Disagree', color: 'bg-red-500' },
//           ].map((responseType) => {
...
//           Based on {leaderData.feedbackCount || 0} feedbacks (categorized by average score)
//         </div>
//       </div> */}
